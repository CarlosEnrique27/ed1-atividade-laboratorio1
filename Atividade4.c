...
void desenharInimigo(Inimigo *ini) {
    ...
    DrawText(TextFormat("%d", ini->vida), (int)ini->pos.x - 8, (int)ini->pos.y - 26, 14, BLACK);
}

int main(void) {
    srand((unsigned int)time(NULL));

    InitWindow(LARGURA_JANELA, ALTURA_JANELA, "Atividade 4 - Ponteiros para Struct");
    SetTargetFPS(60);
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawText("ESPACO atira no mais fraco | C cura todos", 10, 10, 18, DARKGRAY);
